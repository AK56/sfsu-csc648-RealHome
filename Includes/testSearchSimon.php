...
mysql_connect("localhost", "f14g21", "21mgrs2014");
mysql_select_db("student_f14g21");
...
$constructs ="SELECT * FROM Entry WHERE $construct";
...
if(!$start)
$start=0; 
$getquery = mysql_query("SELECT * FROM Entry WHERE $construct LIMIT $start, $per_page");
